...
frecIntensity = [
    482, 5.6 * 10^-3; % Multiplex 22 = Gol, DisneyChannel...
    530, 6 * 10^-3;   % Multiplex 28 = Atreseries HD, RealMadrid TV...
    546, 5.2 * 10^-3; % Multiplex 30 = Telecinco/HD, Cuatro/HD...
    570, 7 * 10^-3;   % Multiplex 33 = TDT/HD, DKiss...
    626, 7.2 * 10^-3; % Multiplex 40 = Aragon TV, Aragon 2 TV...
    642, 8 * 10^-3;   % Multiplex 42 = Boing, Energy, Mega, 13TV...
    674, 8.8 * 10^-3; % Multiplex 46 = La 1/HD, La 2...
    738, 7.8 * 10^-3; % Multiplex 54 = Antena 3/HD, LaSexta/HD...
];
...
uhfFrecuencyAtenuation = [
    482, 12,   22; % Multiplex 22 = Gol, DisneyChannel...
    530, 13.3, 28;   % Multiplex 28 = Atreseries HD, RealMadrid TV...
    546, 13.6, 30; % Multiplex 30 = Telecinco/HD, Cuatro/HD...
    570, 13.9, 33;   % Multiplex 33 = TDT/HD, DKiss...
    626, 14.9, 40; % Multiplex 40 = Aragon TV, Aragon 2 TV...
    642, 15.3, 42;   % Multiplex 42 = Boing, Energy, Mega, 13TV...
    674, 15.7, 46; % Multiplex 46 = La 1/HD, La 2...
    738, 17,   54; % Multiplex 54 = Antena 3/HD, LaSexta/HD...
];
